package com.zhang.demo.common.utils.QRCode;
...
public class QRCodeUtil {
    ...
    /**
     * 生成二维码照片
     * @param content 二维码中的文字内容/跳转链接/其他
     * @param imgPath 二维码图片中间内嵌的小图文件路径地址
     * @param destPath 生成二维码图片后保存的路径及名称
     * @param needCompress
     * @throws Exception
     */
